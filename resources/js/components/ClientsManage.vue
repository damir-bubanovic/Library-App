<template>
	<div>
      ...
      <div class="py-3 mb-4 rounded-lg shadow-md">
        <input v-model="client.name" class="appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" name="name" placeholder="Enter name">
      </div>
      <div class="py-3 mb-4 rounded-lg shadow-md">
        <input v-model="client.email" class="appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" name="email" placeholder="Enter email">
      </div>
      <div class="py-3 mb-4 rounded-lg shadow-md">
      ...
      <div class="py-3 mb-4 rounded-lg shadow-md">
        <input v-model="client.address" class="appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="address" type="text" name="address" placeholder="Enter address">
      </div>
      <div class="py-3 mb-4 rounded-lg shadow-md">
        <input v-model="client.phone_number" class="appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="phone" type="text" name="phone" placeholder="Enter phone: 443.565.8837, 941-986-6148, (417) 352-2239, +12025237727">
      </div>
      <div class="py-3 mb-4 rounded-lg shadow-md">
